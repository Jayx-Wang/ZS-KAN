...
def multiple_convs_kan_conv2d(matrix, #but as torch tensors. Kernel side asume q el kernel es cuadrado
    ...
    # kern_per_out = len(kernels)//out_channels # in_channels # 2:modified!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    kern_per_out = n_channels # 2:modified!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    for c_out in range(out_channels):
        ...
        for k_idx in range(kern_per_out):
            # kernel = kernels[c_out * kern_per_out + k_idx] # 3:modified!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            kernel = kernels[c_out] # 3:modified!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
